                            ...
                            <form action="insertarPelicula" method="POST" enctype="multipart/form-data">
                                ...
                                <div class="mb-3">
                                    ...
                                    <select class="form-control" name="id_genero" id="id_genero" required>
                                        <option class="form-control" value="{$genero[0]->id}" selected>
                                            {$genero[0]->nombre}</option>
                                    </select>
                                </div>
                                <div class="mb-3">
                                                ...
                                                <form action="editarPelicula/{$pelicula->id}" method="POST"
                                                    ...
                                                    <div class="mb-3">
                                                        ...
                                                        <select class="form-control" name="id_genero" id="id_genero"
                                                            value="{$pelicula->id_genero}" required>
                                                            <option class="form-control" value="{$peliculas[0]->id_genero}"
                                                                selected>
                                                                {$peliculas[0]->nombre}</option>
                                                        </select>
                                                    </div>
                                                    <div class="mb-3">
                                                        <label for="video" class="col-form-label">Video:</label>
