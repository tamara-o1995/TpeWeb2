<?php
/* Smarty version 3.1.36, created on 2022-10-18 00:59:52
  from 'C:\xampp\htdocs\TpeWeb2\templates\genero.tpl' */

/* @var Smarty_Internal_Template $_smarty_tpl */
if ($_smarty_tpl->_decodeProperties($_smarty_tpl, array (
  'version' => '3.1.36',
  'unifunc' => 'content_634dde688285d1_61036240',
  'has_nocache_code' => false,
  'file_dependency' => 
  array (
    'c704982bfaeec229604304076b4ccec7878530c1' => 
    array (
      0 => 'C:\\xampp\\htdocs\\TpeWeb2\\templates\\genero.tpl',
      1 => 1666047278,
      2 => 'file',
    ),
  ),
...
function content_634dde688285d1_61036240 (Smarty_Internal_Template $_smarty_tpl) {
$_smarty_tpl->_subTemplateRender("file:header.tpl", $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, 0, $_smarty_tpl->cache_lifetime, array(), 0, false);
?>

<div class="container text-center my-5">
    <div class="container bg-dark mb-5 d-flex justify-content-between">
        <h2><?php echo $_smarty_tpl->tpl_vars['genero']->value[0]->nombre;?>
</h2>
                        ...
                        <div class="modal-body">
                            <form action="insertarPelicula" method="POST" enctype="multipart/form-data">
                                ...
                                <div class="mb-3">
                                    ...
                                    <textarea type="text" class="form-control" name="sinopsis" id="sinopsis"
                                        required></textarea>
                                </div>
                                <div class="mb-3">
                                ...
                                <div class="mb-3">
                                    ...
                                    <select class="form-control" name="id_genero" id="id_genero" required>
                                        <option class="form-control" value="<?php echo $_smarty_tpl->tpl_vars['genero']->value[0]->id;?>
" selected>
                                            <?php echo $_smarty_tpl->tpl_vars['genero']->value[0]->nombre;?>
</option>
                                    </select>
                                </div>
                                <div class="mb-3">
...
" required>
                                                    ...
                                                    <div class="mb-3">
                                                        ...
                                                        <select class="form-control" name="id_genero" id="id_genero"
                                                            value="<?php echo $_smarty_tpl->tpl_vars['pelicula']->value->id_genero;?>
" required>
                                                            <option class="form-control" value="<?php echo $_smarty_tpl->tpl_vars['peliculas']->value[0]->id_genero;?>
"
                                                                selected>
                                                                <?php echo $_smarty_tpl->tpl_vars['peliculas']->value[0]->nombre;?>
</option>
                                                        </select>
                                                    </div>
                                                    <div class="mb-3">
